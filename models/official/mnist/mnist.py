...
class Model(object):
    ...
    """
		...
		self.conv1 = tf.layers.Conv2D(32, 5, padding="same", data_format=data_format, activation=tf.nn.relu)
		self.conv2 = tf.layers.Conv2D(64, 5, padding="same", data_format=data_format, activation=tf.nn.relu)
...
def main(unused_argv):
	...
	mnist_classifier = tf.estimator.Estimator(model_fn=model_fn, model_dir=FLAGS.model_dir, params={"data_format": data_format})
	def train_input_fn():
...
if __name__ == "__main__":
	...
	parser.add_argument("--data_dir", type=str, default="/tmp/mnist_data", help="Path to directory containing the MNIST dataset")
	parser.add_argument("--model_dir", type=str, default="/tmp/mnist_model", help="The directory where the model will be stored.")
	...
	parser.add_argument("--export_dir", type=str, help="The directory where the exported SavedModel will be stored.")
