...
class FasterRCNNResnetV1FeatureExtractor(faster_rcnn_meta_arch.FasterRCNNFeatureExtractor):
    ...
    """
		...
		with tf.control_dependencies([shape_assert]):
			with slim.arg_scope(resnet_utils.resnet_arg_scope(batch_norm_epsilon=1e-5, batch_norm_scale=True, weight_decay=self._weight_decay)):
...
class FasterRCNNResnet50FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
    ...
    """
		super(FasterRCNNResnet50FeatureExtractor, self).__init__("resnet_v1_50", resnet_v1.resnet_v1_50, is_training, first_stage_features_stride, batch_norm_trainable, reuse_weights, weight_decay)
class FasterRCNNResnet101FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
    ...
    Raises:
      ValueError: If `first_stage_features_stride` is not 8 or 16,
        or if `architecture` is not supported.
    """
		super(FasterRCNNResnet101FeatureExtractor, self).__init__("resnet_v1_101", resnet_v1.resnet_v1_101, is_training, first_stage_features_stride, batch_norm_trainable, reuse_weights, weight_decay)
class FasterRCNNResnet152FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
    ...
    Raises:
      ValueError: If `first_stage_features_stride` is not 8 or 16,
        or if `architecture` is not supported.
    """
		super(FasterRCNNResnet152FeatureExtractor, self).__init__("resnet_v1_152", resnet_v1.resnet_v1_152, is_training, first_stage_features_stride, batch_norm_trainable, reuse_weights, weight_decay)