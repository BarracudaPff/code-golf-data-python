...
class BenchmarkPlot:
    ...
    """
	def __init__(self, benchmark_results: BenchmarkResult, loop_colours: List = None, loop_line_styles: List[str] = None, x_axis_metric_name: str = None, metrics_to_plot: List[str] = None):
		"""
