class RemoteRepository(object):
    ...
    """
	def __init__(self, hosting_service, repository_id, name, owner, scm_type, path, mirror_path=None, extra_data={}):
	...
	def __repr__(self):
		return '<RemoteRepository: "%s" (owner=%s, scm_type=%s)>' % (self.name, self.owner, self.scm_type)