...
class HostingServiceAccount(models.Model):
	...
	local_site = models.ForeignKey(LocalSite, related_name="hosting_service_accounts", verbose_name=_("Local site"), blank=True, null=True)
	...
	def is_mutable_by(self, user):
        ...
        """
		return user.has_perm("hostingsvcs.change_hostingserviceaccount", self.local_site)
	def accept_certificate(self, certificate):
		...
		if not certificate.pem_data:
			raise ValueError("The certificate does not include a PEM-encoded " "representation.")
