class SessionResource(WebAPIResource):
	...
	def get(self, request, *args, **kwargs):
		...
		data = {"authenticated": authenticated, "links": self.get_links(request=request, *args, **kwargs)}
	...
	def get_related_links(self, obj=None, request=None, *args, **kwargs):
		...
		if request and request.user.is_authenticated():
			...
			links["delete"] = {"method": "DELETE", "href": clean_href}
			links["user"] = {"method": "GET", "href": href, "title": six.text_type(request.user), "resource": user_resource, "list-resource": False}
		return links
