...
class ResourceTests(ReviewRequestChildItemMixin, BaseWebAPITestCase):
	...
	def setup_review_request_child_test(self, review_request):
		...
		return (get_patched_file_url(review_request, diffset, filediff), patched_file_mimetype)
	...
	def setup_basic_get_test(self, user, with_local_site, local_site_name):
		...
		diffset = self.create_diffset(review_request)
		filediff = self.create_filediff(diffset)
		return (get_patched_file_url(review_request, diffset, filediff, local_site_name=local_site_name), patched_file_mimetype, filediff)
