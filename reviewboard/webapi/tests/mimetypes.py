...
file_attachment_comment_list_mimetype = _build_mimetype("file-attachment-comments")
file_attachment_comment_item_mimetype = _build_mimetype("file-attachment-comment")
...
hosting_service_account_list_mimetype = _build_mimetype("hosting-service-accounts")
hosting_service_account_item_mimetype = _build_mimetype("hosting-service-account")
...
review_reply_diff_comment_list_mimetype = _build_mimetype("review-reply-diff-comments")
review_reply_diff_comment_item_mimetype = _build_mimetype("review-reply-diff-comment")
review_reply_file_attachment_comment_list_mimetype = _build_mimetype("review-reply-file-attachment-comments")
review_reply_file_attachment_comment_item_mimetype = _build_mimetype("review-reply-file-attachment-comment")
review_reply_general_comment_list_mimetype = _build_mimetype("review-reply-general-comments")
review_reply_general_comment_item_mimetype = _build_mimetype("review-reply-general-comment")
review_reply_screenshot_comment_list_mimetype = _build_mimetype("review-reply-screenshot-comments")
review_reply_screenshot_comment_item_mimetype = _build_mimetype("review-reply-screenshot-comment")
...
watched_review_request_item_mimetype = _build_mimetype("watched-review-request")
watched_review_request_list_mimetype = _build_mimetype("watched-review-requests")
