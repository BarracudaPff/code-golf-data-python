...
class FieldTests(TestCase):
	...
	def test_long_bug_numbers(self):
		...
		self.assertEqual(review_request.get_bug_list(), ["4432009", "12006153200030304432010"])
