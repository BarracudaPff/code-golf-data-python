...
class AccountSettingsFormTests(TestCase):
	...
	def setUpClass(cls):
		...
		cls._middleware = [SessionMiddleware(), MessageMiddleware()]
	...
	def test_save_syntax_highlighting_disabled(self):
		...
		with self.siteconfig_settings(settings):
			form = AccountSettingsForm(page, request, user, data={"syntax_highlighting": False, "timezone": profile.timezone})
