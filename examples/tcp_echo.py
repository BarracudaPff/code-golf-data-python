...
ARGS.add_argument("--server", action="store_true", dest="server", default=False, help="Run tcp server")
ARGS.add_argument("--client", action="store_true", dest="client", default=False, help="Run tcp client")
...
ARGS.add_argument("--iocp", action="store_true", dest="iocp", default=False, help="Use IOCP event loop")
