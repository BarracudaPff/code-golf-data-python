...
class MLP(object):
  ...
  """
	def __init__(self, n_hidden=[100], n_classes=10, is_training=True, activation_fn=tf.nn.relu, dropout_rate=0.0, weight_initializer=initializers.xavier_initializer(), weight_regularizer=regularizers.l2_regularizer(0.001)):
		"""
