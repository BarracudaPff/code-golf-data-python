...
installeventhandler(unicodeNumbers, "TeCoUnum", ("----", "text", kAE.typeUnicodeText))
...
installeventhandler(unicodeCharacters, "TeCoUcha", ("----", "intList", ArgListOf(kAE.typeInteger)))
...
installeventhandler(stripText, "TeCoStrp", ("----", "text", kAE.typeUnicodeText), ("Remo", "removing", kAE.typeUnicodeText), ("From", "fromEnd", ArgEnum("Left", "Rght", "Both")))
starteventloop()