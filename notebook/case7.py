...
data_config = {"remote.data.address": "tcp://data.tushare.org:8910", "remote.data.username": "phone", "remote.data.password": "token"}
trade_config = {"remote.trade.address": "tcp://gw.quantos.org:8901", "remote.trade.username": "phone", "remote.trade.password": "token"}
...
def save_dataview():
	...
	dv = DataView()
	props = {"start_date": start_date, "end_date": end_date, "universe": universe, "fields": "roe_yearly,roa_yearly", "freq": 1}
...
def alpha_strategy_backtest():
	...
	props = {"benchmark": benchmark, "universe": ",".join(dv.symbol), "start_date": dv.start_date, "end_date": dv.end_date, "period": "month", "days_delay": 0, "init_balance": 1e8, "position_ratio": 1.0}
