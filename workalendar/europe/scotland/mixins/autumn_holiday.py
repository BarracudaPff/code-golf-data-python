...
class AutumnHolidaySecondMondayOctober(AutumHoliday):
	def get_autumn_holiday(self, year):
		return (self.get_nth_weekday_in_month(year, 10, MON, 2), self.autumn_holiday_label)
class AutumnHolidayThirdMondayOctober(AutumHoliday):
	def get_autumn_holiday(self, year):
		return (self.get_nth_weekday_in_month(year, 10, MON, 3), self.autumn_holiday_label)