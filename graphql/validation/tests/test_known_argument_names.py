...
from graphql.validation.rules.known_argument_names import KnownArgumentNames, _unknown_arg_message, _unknown_directive_arg_message
...
def unknown_arg(arg_name, field_name, type_name, suggested_args, line, column):
	return {"message": _unknown_arg_message(arg_name, field_name, type_name, suggested_args), "locations": [SourceLocation(line, column)]}
def unknown_directive_arg(arg_name, directive_name, suggested_args, line, column):
	return {"message": _unknown_directive_arg_message(arg_name, directive_name, suggested_args), "locations": [SourceLocation(line, column)]}
...
def test_unknown_args_amongst_known_args():
    ...
    """,
		[unknown_arg("whoknows", "doesKnowCommand", "Dog", [], 3, 25), unknown_arg("unknown", "doesKnowCommand", "Dog", [], 3, 55)],
	)
def test_unknown_args_deeply():
    ...
    """,
		[unknown_arg("unknown", "doesKnowCommand", "Dog", [], 4, 27), unknown_arg("unknown", "doesKnowCommand", "Dog", [], 9, 31)],
	)