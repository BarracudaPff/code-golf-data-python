...
import argparse
import boto3
TABLES = {"app": {"prefix": "todo-app", "env_var": "APP_TABLE_NAME", "hash_key": "username", "range_key": "uid"}, "users": {"prefix": "users-app", "env_var": "USERS_TABLE_NAME", "hash_key": "username"}}
...
def main():
	...
	parser.add_argument("-t", "--table-type", default="app", choices=["app", "users"], help="Specify which type to create")
