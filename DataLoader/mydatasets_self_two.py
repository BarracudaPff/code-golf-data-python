...
class MR(data.Dataset):
	...
	def char_data(self, list):
		...
		return data
	@classmethod
	def splits(cls, path, train, dev, test, char_data, text_field, label_field, dev_ratio=0.1, shuffle=True, root=".", **kwargs):
		...
		return (cls(text_field, label_field, examples=examples_train), cls(text_field, label_field, examples=examples_dev), cls(text_field, label_field, examples=examples_test))