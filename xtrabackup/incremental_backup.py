...
def main():
	...
	try:
		backup_tool = BackupTool(arguments["--log-file"], arguments["--out-file"], arguments["--no-compress"], arguments["--debug"])
		backup_tool.start_incremental_backup(arguments["<repository>"], arguments["--incremental"], arguments["--tmp-dir"], arguments["--user"], arguments["--password"], arguments["--backup-threads"])
	except Exception:
