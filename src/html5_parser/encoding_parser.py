...
class EncodingParser(object):
	...
	def __init__(self, data):
		...
		self.encoding = None
	def __call__(self):
		dispatch = ((b"<!--", self.handle_comment), (b"<meta", self.handle_meta), (b"</", self.handle_possible_end_tag), (b"<!", self.handle_other), (b"<?", self.handle_other), (b"<", self.handle_possible_start_tag))
