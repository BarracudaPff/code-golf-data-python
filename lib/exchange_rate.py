CCY_PRECISIONS = {"BHD": 3, "BIF": 0, "BYR": 0, "CLF": 4, "CLP": 0, "CVE": 0, "DJF": 0, "GNF": 0, "IQD": 3, "ISK": 0, "JOD": 3, "JPY": 0, "KMF": 0, "KRW": 0, "KWD": 3, "LYD": 3, "MGA": 1, "MRO": 1, "OMR": 3, "PYG": 0, "RWF": 0, "TND": 3, "UGX": 0, "UYI": 0, "VND": 0, "VUV": 0, "XAF": 0, "XAU": 4, "XOF": 0, "XPF": 0}
...
class CryptoCompare(ExchangeBase):
	def get_rates(self, ccy):
		json = self.get_json("min-api.cryptocompare.com", "/data/pricehistorical?fsym=ZCL&tsyms=USD")
		return {"USD": Decimal(json["ZCL"]["USD"])}
class CoinMarketCap(ExchangeBase):
	def get_rates(self, ccy):
		json = self.get_json("api.coinmarketcap.com", "/v1/ticker/zclassic?convert=%s")
