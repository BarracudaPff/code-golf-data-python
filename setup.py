...
setup_args = {"name": "zyredis", "version": __version__, "description": "ireader redis client", "long_description": open("README.md").read(), "author": "WangLichao", "author_email": "wanglichao@zhangyue.com", "packages": packages, "data_files": data_files, "include_package_data": True}
setup(**setup_args)