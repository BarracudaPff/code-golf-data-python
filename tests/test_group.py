...
from pytradfri.const import ATTR_LIGHT_MIREDS, ATTR_LIGHT_COLOR_HUE, ATTR_LIGHT_COLOR_SATURATION, ATTR_LIGHT_DIMMER
...
def test_setters():
	...
	assert cmd.data == {ATTR_LIGHT_COLOR_HUE: 300, ATTR_LIGHT_COLOR_SATURATION: 200, ATTR_LIGHT_DIMMER: 100}