...
class LocationTests(unittest.TestCase):
	def test_location_name(self):
		...
		self.assertEqual((u"Animal__out_Animal_ParentOf___1", None), child_location.get_location_name())
		child_at_field = child_location.navigate_to_field(u"name")
		self.assertEqual((u"Animal__out_Animal_ParentOf___1", u"name"), child_at_field.get_location_name())
	def test_location_comparisons(self):
		sorted_locations = [Location(("Animal", "in_Animal_Parent_of"), "uuid", 3), Location(("Animal", "in_Animal_Parent_of", "in_Animal_FedAt"), "name", 2), Location(("Animal", "in_Animal_Parent_of", "out_Animal_FedAt"), "name", 1), Location(("Animal", "in_Animal_Parent_of", "out_Animal_FedAt"), None, 2), Location(("Animal", "in_Animal_Parent_of", "out_Animal_FedAt"), "name", 2), Location(("Animal", "in_Animal_Parent_of", "out_Animal_FedAt"), "uuid", 2)]
		for i in range(len(sorted_locations)):
			first_location = sorted_locations[i]
			for j in range(len(sorted_locations)):
				second_location = sorted_locations[j]
	...
	def test_fold_scope_location_comparisons(self):
		sorted_locations = [FoldScopeLocation(Location(("Animal", "in_Animal_Parent_of")), (("in", "Animal_OfSpecies"),), None), FoldScopeLocation(Location(("Animal", "in_Animal_Parent_of")), (("out", "Animal_OfSpecies"),), None), FoldScopeLocation(Location(("Animal", "in_Animal_Parent_of")), (("out", "Animal_OfSpecies"), ("in", "out_Animal_FedAt")), None), FoldScopeLocation(Location(("Animal", "in_Animal_Parent_of")), (("out", "Animal_OfSpecies"), ("in", "out_Animal_FedAt")), "name"), FoldScopeLocation(Location(("Animal", "in_Animal_Parent_of")), (("out", "Animal_OfSpecies"), ("in", "out_Animal_FedAt")), "uuid")]
		for i in range(len(sorted_locations)):
			first_location = sorted_locations[i]
			for j in range(len(sorted_locations)):
				second_location = sorted_locations[j]
	...
	def test_mixed_location_comparisons(self):
		sorted_locations = [FoldScopeLocation(Location(("Animal", "in_Animal_Parent_of")), (("in", "Animal_OfSpecies"),), None), Location(("Animal", "in_Animal_Parent_of"), "name"), FoldScopeLocation(Location(("Animal", "out_Animal_Parent_of")), (("in", "Animal_OfSpecies"),), None)]
